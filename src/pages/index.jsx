...
function Resume() {
  ...
  return (
    <div className="rounded-2xl border border-zinc-100 p-6 dark:border-zinc-700/40">
      ...
      <Button href="./_cv english full stack.pdf" variant="secondary" className="group mt-6 w-full">
        Download Resume
    ...
    <>
      ...
      <Container className="mt-9">
        <div className="max-w-2xl">
          ...
          Hi, I’m Firas, a dedicated full-stack developer. 
          ...
          <div className="mt-6 flex gap-6">
            ...
            <SocialLink
              href="https://www.instagram.com/firasml/"
              aria-label="Follow on Instagram"
              icon={InstagramIcon}
            />
            <SocialLink
              href="https://github.com/MLfiras065"
              aria-label="Follow on GitHub"
              icon={GitHubIcon}
            />
            <SocialLink
              href="https://www.linkedin.com/firas-mlayeh-42b6431b8/"
